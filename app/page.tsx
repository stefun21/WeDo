    ...
    <main className="app-shell">
      ...
      <section className="content">
        <header className="topbar">
          ...
          <button className="profile-button"><b>SF</b><span>Stefan</span><ChevronDown /></button>
        </header>
        ...
        <div className="dashboard">
          <section className="welcome-row">
            <div>
              ...
              <h1>Good evening, Stefan</h1>
              <div className="group-line">
                <button className="group-select"><Home /> Our Home <ChevronDown /></button>
                <div className="avatar-stack hero-avatars"><i>SF</i><i>AM</i><i>JD</i><i>+1</i></div>
              </div>
            </div>
